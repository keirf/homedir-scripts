...
(defvar kaf::fifth-frm nil "Fifth frame")

(let* ((kaf::frame-height 143)
       (kaf::left-gap 220)
       (kaf::top-gap 0)
       (kaf::left-frm-props
  ...
  (setq kaf::fifth-frm (make-frame kaf::fifth-frm-props))
  (set-frame-position kaf::right-frm 890 kaf::top-gap)
  (set-frame-position kaf::third-frm 1560 kaf::top-gap)
  (set-frame-position kaf::fourth-frm 2230 kaf::top-gap)
  (set-frame-position kaf::fifth-frm 2900 kaf::top-gap)
)
